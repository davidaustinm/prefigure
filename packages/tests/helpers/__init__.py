...
``compare`` mirrors ``packages/prefig-rust/prefig-core/tests/svg_compare.rs`` and ``build_helper``
mirrors the ``build_one`` routine used to generate the reference snapshots. They read the
